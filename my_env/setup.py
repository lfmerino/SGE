...
setup(
    ...
    url="http://brianda.es",
    packages=['odoo','odoo.addons','odoo.addons.tarea5','odoo.addons.tarea5.julio',
              'odoo.addons.tarea5.julio.P123','odoo.addons.tarea5.julio.P4',
              'odoo.addons.tarea5.julio.P5'],
    scripts=[]
)
