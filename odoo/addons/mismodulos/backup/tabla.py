  ...
  #      self.cCPn = input("CP: ")
   #     self.cPoblacion=input("Población: ")
    ...
    #def 
        ...
        def login(self):
            letra1 = self.MiNombre[:0].lower()
            espacio1=self.MiNombre.find(" ")+1
            espacio2=self.MiNombre.find(" ",espacio1)+1
            apellido=self.MiNombre[espacio1:espacio2].lower()
            self.Mlogin = letra1+apellido
            print(self.Minombre+" "+self.Mlogin)            
