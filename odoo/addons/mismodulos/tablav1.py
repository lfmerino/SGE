...
class DicClientes:
    ...
    def Datos(self):
        ...
        while True:
            ...
            #vOpc = 
            #vOpc=input("ESC para volver al menú: ")
            #if vOpc=="":
             #   vOpc="S"
        '''while vOpc.upper()=="S":
            vCliente=Cliente()
    ...
    def Pintar(self):
        ...
        print ("0 - Salir")
        print (" ------------------------------ ") 
        self.aOpc=int(input ("Elige una opcion: "))

def pulsaESC():
    print("Pulsa ESC para volver o cualquier tecla para continuar...")
    print()
...
while MiTabla.aOpc>0:
    switch_menu.get(MiTabla.aOpc, MiTabla.error)()
    MiTabla.Pintar()
